        ...
        <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-zinc-800 shadow-2xl space-y-6 relative">
          ...
          <div className="grid grid-cols-2 gap-1 p-1 bg-zinc-950 rounded-xl border border-zinc-800 text-xs">
            <button
              ...
              className={`py-2 px-3 rounded-lg font-medium flex items-center justify-center gap-1.5 transition-all ${loginScope === 'customer'
            ...
            <button
              ...
              className={`py-2 px-3 rounded-lg font-medium flex items-center justify-center gap-1.5 transition-all ${loginScope === 'staff'
                  ? 'bg-zinc-800 text-champagne font-bold shadow-sm border border-champagne/30'
                  : 'text-cream/60 hover:text-cream'
                }`}
            >
                ...
                {(Object.keys(DEMO_PERSONAS) as DemoPersonaKey[]).map((key) => {
                  ...
                  return (
                    <button
                      ...
                      className={`py-2 px-1 rounded-lg text-xs font-medium transition-all text-center flex flex-col items-center gap-0.5 ${active
                          ? 'bg-zinc-800 text-champagne font-bold shadow-sm border border-champagne/30'
