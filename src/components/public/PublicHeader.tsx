...
export function PublicHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-obsidian-950/95 backdrop-blur-xl border-b border-emerald-900/40 shadow-2xl">
      {/* Top Notification Bar */}
      <div className="bg-obsidian-900/90 border-b border-emerald-950/80 text-xs text-cream/70 py-1.5 px-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1.5 text-champagne font-mono text-[11px]">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden lg:flex items-center gap-1 xl:gap-2">
            ...
            >
              ...
              {productsOpen && (
                <div className="absolute top-full left-0 w-72 bg-obsidian-900/95 border border-emerald-900/60 rounded-xl shadow-2xl p-3 grid gap-1 animate-fade-in backdrop-blur-xl">
                  <Link
                    href="/products?category=fresh_produce"
                    className="p-2.5 rounded-lg hover:bg-emerald-950/60 transition-colors group"
                  >
            ...
            >
              ...
              {sectorsOpen && (
                <div className="absolute top-full left-0 w-80 bg-obsidian-900/95 border border-emerald-900/60 rounded-xl shadow-2xl p-3 grid gap-1 animate-fade-in backdrop-blur-xl">
                  <Link href="/sectors/restaurants" className="p-2.5 rounded-lg hover:bg-emerald-950/60 transition-colors group">
                  ...
                  <Link href="/sectors/hotels" className="p-2.5 rounded-lg hover:bg-emerald-950/60 transition-colors group">
                  ...
                  <Link href="/sectors/care-homes" className="p-2.5 rounded-lg hover:bg-emerald-950/60 transition-colors group">
                  ...
                  <Link href="/sectors/caterers" className="p-2.5 rounded-lg hover:bg-emerald-950/60 transition-colors group">
                  ...
                  <Link href="/sectors/pubs-bars" className="p-2.5 rounded-lg hover:bg-emerald-950/60 transition-colors group">
                  ...
                  <Link href="/sectors/schools" className="p-2.5 rounded-lg hover:bg-emerald-950/60 transition-colors group">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <Link
              href="/login"
              className="px-4 py-2 text-sm font-medium text-cream/90 hover:text-champagne border border-emerald-800/60 bg-emerald-950/30 rounded-xl hover:border-champagne/60 transition-all shadow-sm"
            >
              Customer Login
            </Link>
            <Link
              href="/onboarding"
              className="px-5 py-2.5 text-sm font-semibold text-obsidian-950 bg-gradient-to-r from-champagne-soft via-champagne to-champagne-dim rounded-xl hover:brightness-110 shadow-gold-glow transition-all flex items-center gap-2"
            >
        ...
        <div className="lg:hidden bg-obsidian-900 border-b border-cream/15 px-4 pt-4 pb-6 space-y-4 animate-slide-up">
          ...
          <div className="pt-4 border-t border-emerald-900/60 grid gap-2">
            <Link
              ...
              className="w-full text-center py-3 font-semibold text-obsidian-950 bg-champagne rounded-xl shadow-gold-glow"
            >
            ...
            <Link
              href="/login"
              onClick={() => setMobileOpen(false)}
              className="w-full text-center py-2.5 font-medium text-cream border border-cream/20 rounded-xl"
            >
