...
export function PriceEstimator() {
  ...
  return (
    <div className="glass-panel-gold rounded-2xl p-6 sm:p-8 lg:p-10 shadow-2xl relative overflow-hidden">
      {/* Decorative glow */}
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center space-y-2 mb-8">
          ...
          <p className="text-sm text-cream/70 max-w-lg mx-auto">
        ...
        {!submitted ? (
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <label className="text-xs font-mono uppercase tracking-wider text-cream/70">
                ...
                />
                <div className="flex justify-between text-[11px] text-cream/40 mt-1 font-mono">
                  <span>£500</span>
                  <span>£5,000</span>
                  <span>£10,000</span>
                  <span>£15,000+</span>
            ...
            <div className="grid grid-cols-2 gap-4 bg-obsidian-950/80 border border-cream/10 rounded-xl p-4 sm:p-6 text-center">
              <div>
                <div className="text-xs text-cream/60 uppercase font-mono">Estimated Monthly Savings</div>
                <div className="text-2xl sm:text-3xl font-bold font-display text-champagne mt-1">
                  £{monthlySavings.toLocaleString()}
                </div>
                <div className="text-[11px] text-cream/40 mt-0.5">based on ~12% direct-tier pricing</div>
              </div>
              <div className="border-l border-cream/10">
                <div className="text-xs text-cream/60 uppercase font-mono">Projected Annual Bottom-Line</div>
                ...
                <div className="text-[11px] text-emerald-400/80 mt-0.5">retained gross kitchen profit</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 pt-2">
              <input
                ...
                className="bg-obsidian-900 border border-cream/20 rounded-lg px-3.5 py-2.5 text-xs text-cream focus:outline-none focus:border-champagne"
              />
              <input
                type="text"
          ...
          <div className="text-center py-8 space-y-4 animate-fade-in">
            ...
            <h4 className="font-display text-2xl font-bold text-cream">
