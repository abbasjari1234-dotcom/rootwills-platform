    ...
    <section className="py-16 lg:py-20 bg-[#F9FAFB]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm grid grid-cols-1 md:grid-cols-12 items-stretch">
          ...
          <div className="md:col-span-5 relative min-h-[220px] md:min-h-[280px] bg-slate-100 overflow-hidden">
            <Image
          ...
          <div className="md:col-span-7 p-8 sm:p-10 lg:p-12 flex flex-col justify-center">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-sans font-extrabold text-slate-900 tracking-tight leading-tight mb-3">
            ...
            <div className="flex flex-col items-start gap-3.5">
              <Link
                href="/apply"
                className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-[#14532d] hover:bg-[#166534] text-white font-sans font-bold text-sm shadow-sm transition-all duration-200 transform hover:-translate-y-0.5"
              >
              ...
              <Link
                href="/contact"
                className="text-xs sm:text-sm font-sans font-semibold text-emerald-700 hover:text-emerald-800 hover:underline inline-flex items-center gap-1.5 pt-1"
              >
