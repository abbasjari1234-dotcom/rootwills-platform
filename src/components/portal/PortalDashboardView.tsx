...
export function PortalDashboardView() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-6 border-b border-emerald-950/80">
        <div>
          <div className="flex items-center gap-2">
            <span className="px-3 py-1 rounded-full bg-emerald-950/90 border border-emerald-500/30 text-emerald-400 text-[11px] font-mono uppercase font-bold tracking-wider">
          ...
          <h1 className="font-display text-2xl sm:text-3xl font-bold text-cream mt-2 tracking-tight">
      ...
      <div className="glass-panel-emerald p-6 sm:p-7 rounded-2xl relative overflow-hidden border border-emerald-500/20 shadow-lg">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
          ...
          <div className="md:col-span-4 grid grid-cols-2 gap-3 font-mono text-xs">
            <div className="p-3.5 rounded-xl bg-obsidian-950/80 border border-emerald-900/50 text-left">
              ...
              <div className="text-[10px] text-emerald-400/80">✓ BRCGS Grade A</div>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-obsidian-950/80 border border-emerald-900/50 text-left">
              ...
              <div className="text-[10px] text-zinc-400">On-Time Matrix</div>
            </div>
          </div>
      ...
      {lastOrder && (
        <div className="glass-panel-gold p-6 sm:p-7 rounded-2xl relative overflow-hidden border border-champagne/30 shadow-xl">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
            ...
            <div className="flex flex-col sm:flex-row lg:flex-col gap-2.5 justify-end">
              <button
                ...
                className="w-full py-3.5 px-6 rounded-xl bg-gradient-to-r from-champagne-soft via-champagne to-champagne-dim text-obsidian-950 font-bold text-xs sm:text-sm shadow-gold-glow hover:brightness-110 flex items-center justify-center gap-2 transition-all"
              >
                <Repeat className="w-4 h-4" />
              ...
              <Link
                ...
                className="text-center py-2 text-xs text-cream/60 hover:text-champagne font-mono transition-colors"
              >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="glass-panel p-5 rounded-2xl space-y-2 h-full border border-emerald-950/80 hover:border-champagne/30 transition-all shadow-sm">
          <div className="text-[11px] font-mono uppercase text-cream/50 tracking-wider">Approved Trade Credit</div>
        ...
        <div className="glass-panel p-5 rounded-2xl space-y-2 h-full border border-emerald-950/80 hover:border-champagne/30 transition-all shadow-sm">
          <div className="text-[11px] font-mono uppercase text-cream/50 tracking-wider">Available Purchasing Power</div>
          ...
          <div className="w-full bg-obsidian-900 h-1.5 rounded-full overflow-hidden">
            <div className="bg-emerald-400 h-full transition-all duration-300" style={{ width: `${100 - creditUsagePercent}%` }} />
          </div>
        </div>

        <div className="glass-panel p-5 rounded-2xl space-y-2 h-full border border-emerald-950/80 hover:border-champagne/30 transition-all shadow-sm">
          <div className="text-[11px] font-mono uppercase text-cream/50 tracking-wider">Outstanding Invoices</div>
        ...
        <div className="glass-panel p-5 rounded-2xl space-y-1.5 h-full border border-emerald-950/80 hover:border-champagne/30 transition-all shadow-sm">
          <div className="text-[11px] font-mono uppercase text-champagne font-bold tracking-wider">Commercial Account Rep</div>
