  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse at 50% 40%, rgba(228,199,103,0.05) 0%, transparent 55%),
            radial-gradient(ellipse at 30% 70%, rgba(16,185,129,0.04) 0%, transparent 50%),
      ...
      <div className="act-cta-content relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto py-20">
        ...
        <div className="act-cta-ornament mb-8 flex justify-center">
          <div className="w-px h-16 bg-gradient-to-b from-transparent via-champagne/35 to-champagne/10" />
        </div>
        ...
        <h2 className="act-cta-title font-display text-3xl sm:text-5xl lg:text-7xl font-black uppercase leading-[0.88] tracking-tight">
          ...
          <span className="block gold-gradient-text mt-2 sm:mt-3">Your Kitchen?</span>
        </h2>
        ...
        <div className="act-cta-stats mt-14 sm:mt-16 grid grid-cols-3 gap-6 sm:gap-8 max-w-md mx-auto">
          <div className="text-center">
            <div className="text-xl sm:text-2xl font-display font-black text-cream">500+</div>
            <div className="text-[8px] sm:text-[9px] font-mono uppercase tracking-[0.2em] text-cream/30 mt-1">
              Trade Clients
            </div>
          </div>
          <div className="text-center">
            <div className="text-xl sm:text-2xl font-display font-black text-champagne">6 AM</div>
            <div className="text-[8px] sm:text-[9px] font-mono uppercase tracking-[0.2em] text-cream/30 mt-1">
              Daily Delivery
            </div>
          </div>
          <div className="text-center">
            <div className="text-xl sm:text-2xl font-display font-black text-emerald-400">99.2%</div>
            <div className="text-[8px] sm:text-[9px] font-mono uppercase tracking-[0.2em] text-cream/30 mt-1">
              Fill Rate
            </div>
          </div>
