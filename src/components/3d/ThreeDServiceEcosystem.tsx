...
const SERVICE_DIMENSIONS: ServiceDimension[] = [
  ...
  },
  {
    id: 'butchery',
    step: '03',
    tag: 'Dimension 03: Culinary Engineering',
    title: 'Chef-Tailored Butchery & Artisan Dry Goods',
    subtitle: 'Prime dry-aged beef, portion-controlled cuts, and Valrhona pastry.',
    description: 'We speak the language of professional executive kitchens. Hand-cut dry-aged British beef primals, living hydroponic herb trays, French cultured butter, and pastry staples tailored to your exact menu portions.',
    stats: [
      { label: 'Dry-Aging Chamber', value: '28–45 Days', color: '#E4C767' },
      { label: 'Portion Variance', value: '< 2% Precision', color: '#10B981' },
      { label: 'Substitutions', value: '0% Without Consent', color: '#34D399' },
    ],
    deliverables: [
      'Bespoke culinary portion specs',
      'Master butcher hand-cut primals',
      'Living root microgreens with zero soil grit',
      'Direct commercial account desk support'
    ],
    ctaText: 'Browse Butchery & Artisan Lines',
    ctaHref: '/products?category=meat_poultry',
    meshType: 'butchery',
    color: '#E4C767',
    accentColor: '#F5E498',
  },
