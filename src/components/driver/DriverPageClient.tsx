  ...
  return (
    <div className="min-h-screen bg-obsidian-950 text-cream p-4 sm:p-6 max-w-lg mx-auto space-y-6">
      ...
      <div className="space-y-3">
        <h3 className="font-mono text-xs uppercase tracking-wider text-cream/60 font-bold flex justify-between">
            ...
            {podMode === 'photo' && (
              <div className="space-y-3 text-xs animate-fade-in">
                ...
                {photoPreview ? (
                  ...
                  >
                    <span className="w-10 h-10 rounded-full bg-champagne/10 text-champagne flex items-center justify-center">
                      <Camera className="w-5 h-5" />
                    </span>
                    <span className="font-bold text-xs block">Snap Keyholder Drop Photo</span>
                    <span className="text-[10px] text-cream/40 block">Kitchen inwards entrance / Cold room drop</span>
                  </button>
                )}
              </div>
            )}
